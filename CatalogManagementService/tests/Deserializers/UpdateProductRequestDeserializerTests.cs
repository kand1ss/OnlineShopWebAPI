...
public class UpdateProductRequestDeserializerTests
{
    private readonly UpdateProductRequestDeserializer _deserializer = new();
    ...
    {
        var request = new UpdateProductRequest(Guid.NewGuid(), title, description, price);
